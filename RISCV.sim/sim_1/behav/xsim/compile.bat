...
REM
REM Generated by Vivado on Thu Feb 02 15:20:27 +0530 2023
...
echo "xvlog --incr --relax -prj mux4_tb_vlog.prj"
call xvlog  --incr --relax -prj mux4_tb_vlog.prj -log xvlog.log
