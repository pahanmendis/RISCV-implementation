...
REM
REM Generated by Vivado on Thu Feb 02 10:25:56 +0530 2023
...
echo "xvlog --incr --relax -prj RICV_tb_vlog.prj"
call xvlog  --incr --relax -prj RICV_tb_vlog.prj -log xvlog.log
